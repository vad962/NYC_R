(function () {
    ...
    //Cesium.Ion.defaultAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJjODE5ZTdjNi05YmQzLTQ3NTUtYTk1Ni0zMzc1YTNkOGQwNTIiLCJpZCI6MjA5OTUsInNjb3BlcyI6WyJhc3IiLCJnYyJdLCJpYXQiOjE1Nzg2NTg4NTh9.Q7uPPr_XO8KQlDwU0nV6YFCjPYKY1h--KuanqVmUEps';

    Cesium.Ion.defaultAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJlYjdmMjA5MC02ZGI3LTRhNWMtOGI0Ny05OTE2MWMyZWNkNjUiLCJpZCI6MjA5OTUsInNjb3BlcyI6WyJhc2wiLCJhc3IiLCJhc3ciLCJnYyJdLCJpYXQiOjE1Nzg4OTkxNzJ9.l3Qi-8ODp_wnU9fkAwJJFlRz6BsUQCWmMfz1DUZMYCo';
    
    //Cesium.Ion.defaultAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJjODE5ZTdjNi05YmQzLTQ3NTUtYTk1Ni0zMzc1YTNkOGQwNTIiLCJpZCI6MjA		//5OTUsInNjb3BlcyI6WyJhc3IiLCJnYyJdLCJpYXQiOjE1Nzg2NTg4NTh9.Q7uPPr_XO8KQlDwU0nV6YFCjPYKY1h--KuanqVmUEps';
    ...
    var city1 = viewer.scene.primitives.add(new Cesium.Cesium3DTileset({ url: Cesium.IonResource.fromAssetId(57587) }));

    //viewer.zoomTo(city).otherwise(function (error) {
    //        console.log(error);
    //    });
